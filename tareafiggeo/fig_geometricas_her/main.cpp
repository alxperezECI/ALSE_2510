...
int main(){
    ...
    cout << pG << endl;
cout << "Prueba de seCruzaCon" << endl;
    Circulo c1 = Circulo(2.0, 0.0, 0.0);
    Circulo c2 = Circulo(1.0, 3.0, 3.0);
    cout << "Perímetro: " << c1.perimetro() << " y área: " << c1.area() << endl;
    cout << "Perímetro: " << c2.perimetro() << " y área: " << c2.area() << endl;
    c2.seCruzaCon(c1); 
